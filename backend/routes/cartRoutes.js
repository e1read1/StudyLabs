...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    if (cart) {
      ...
      // if the cart doesn't exist, create a new one for guest or user
...
// @route GET /api/cart
// @desc Get a guest or logged in user cart
// @access public
...
// @desc Merge a guest cart into user cart on login
// @access private
router.post("/merge", protect, async (req, res) => {
  ...
  try {
    ...
    if (guestCart) {
      ...
      if (userCart) {
        // merge the products from guest cart to user cart
        ...
        // assign the guest cart to user if the user cart doesn't exist
